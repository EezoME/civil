...
<div class="content">
    ...
    <div class="new-form">
        <form action="newProject" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="title" id="prj-title" placeholder="Назва"
                   value="${not empty savedValues.title ? savedValues.title[0] : ''}"/><br>
            ...
            <textarea name="desc"
                      id="prj-description">${not empty savedValues.desc ? savedValues.desc[0] : ''}</textarea><br>

            <label for="prj-sum">Необхідна сума</label><br>
            <input type="text" name="sum" id="prj-sum" placeholder="5 000"
                   value="${not empty savedValues.sum ? savedValuesr.sum[0] : ''}"/><span
                class="larger">&nbsp;&#8372;</span><br>

            <label for="prj-sum">Дата завершення</label><br>
            <input type="date" name="date" id="prj-date"
                   value="${not empty savedValues.date ? savedValues.date[0] : ''}"/><br>
